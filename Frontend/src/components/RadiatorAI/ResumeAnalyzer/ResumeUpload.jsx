...
const ResumeUpload = ({ onAnalyze, loading }) => {
  ...
  const inputFields = [
    ...
    { 
      ...
      placeholder: "Stanford, University of Toronto", 
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl px-6 md:px-8">
      {/* <div className="text-center mb-8">
        <p className="text-gray-600 max-w-lg mx-auto">
          Upload your resume to get personalized feedback for your target program
        </p>
      </div> */}
          ...
          <div key={field.name} className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-3 focus:ring-blue-500/20 outline-none transition-all duration-300 bg-white/50 backdrop-blur-sm"
